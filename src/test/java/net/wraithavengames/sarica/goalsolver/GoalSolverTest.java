...
import net.wraithavengames.sarica.goalsolver.impl.GoalSolver;
import net.wraithavengames.sarica.goalsolver.impl.Heuristic;
import net.wraithavengames.sarica.goalsolver.impl.Task;
import net.wraithavengames.sarica.goalsolver.impl.TaskHandler;
import net.wraithavengames.sarica.goalsolver.impl.TaskResults;
import net.wraithavengames.sarica.goalsolver.impl.TaskType;
...
class GoalSolverTest {
    ...
    void chooseBest_simpleHandlerList() throws InterruptedException, ExecutionException {
        ...
        when(handler1.getHeuristic(any()))
                .thenReturn(CompletableFuture.supplyAsync(() -> new Heuristic(task, handler1, false, 0f)));
        ...
        when(handler2.getHeuristic(any()))
                .thenReturn(CompletableFuture.supplyAsync(() -> new Heuristic(task, handler2, true, 2f)));
        ...
        when(handler3.getHeuristic(any()))
                .thenReturn(CompletableFuture.supplyAsync(() -> new Heuristic(task, handler3, true, 30f)));
